  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="heading-large text-white mb-2">Patient Management</h1>
      ...
      <div className="space-y-4">
        {filteredPatients.map((patient) => (
          <div key={patient.id} className="card p-6 hover:bg-white/5 transition-colors">
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  {/* Patient Info */}
                  <div>
                    <h4 className="text-sm font-medium text-gray-300 mb-2">Conditions</h4>
                  ...
                  {/* Vitals */}
                  <div>
                    <h4 className="text-sm font-medium text-gray-300 mb-2">Latest Vitals</h4>
                    <div className="grid grid-cols-2 gap-2 text-xs">
                      <div>
                        <span className="text-gray-400">BP:</span>
                        <span className="text-white ml-1">{patient.vitals.bloodPressure}</span>
                      </div>
                      <div>
                        <span className="text-gray-400">HR:</span>
                        <span className="text-white ml-1">{patient.vitals.heartRate} bpm</span>
                      </div>
                      <div>
                        <span className="text-gray-400">Temp:</span>
                        <span className="text-white ml-1">{patient.vitals.temperature}°F</span>
                      </div>
                      <div>
                        <span className="text-gray-400">Weight:</span>
                        <span className="text-white ml-1">{patient.vitals.weight} lbs</span>
                      </div>
                    </div>
                  ...
                  {/* Alerts */}
                  <div>
                    <h4 className="text-sm font-medium text-gray-300 mb-2">Alerts</h4>
                      ...
                      <div className="space-y-1">
                        {patient.alerts.slice(0, 2).map((alert, index) => (
                          <div key={index} className="text-xs">
                            ...
                            <span className="text-gray-300 ml-1">{alert.message}</span>
                          </div>
                        ))}
